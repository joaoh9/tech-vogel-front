  ...
  <div>
    ...
    <div class="ma-12 container">
      ...
      <div class="d-flex justify-start">
        ...
        <p class="mr-8">{{this.jobTest.type}}</p>
        <p class="mr-8">{{this.jobTest.category}}</p>
      </div>
      <div>
        <v-chip
