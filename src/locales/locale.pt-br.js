...
export default {
  ...
  LandingPage: {
    title: 'Conectando Empresas com Desenvolvedores para trabalho remoto',
    ...
    CTATittle: 'Cadastre-se agora para receber as novidades!',
    inputs: {
      email: {
        title: 'Email',
      ...
      name: {
        title: 'Nome',
        hint: 'Por favor escreva pelo menos 5 letras',
        errorMessage: 'Seu nome deve ter pelo menos 5 letras',
      },
      skills: {
        title: 'Escolha suas habilidades (linguagens de programação, frameworks, áreas de atuação etc)',
        hint: 'Por favor escolha pelo menos 3 habilidades',
      },
    },
    buttons: {
      goBack: 'Voltar',
  ...
  languages: {
    data: [
      ...
      { i18n: 'us-en', language: 'English', country: 'usa' },
    ],
    icons: FlagIcons,
  },
};
